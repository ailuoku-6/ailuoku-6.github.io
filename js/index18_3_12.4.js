...
var allsite = new Vue({
  ...
  data:{
    ...
    Marchinelist:[
      {Marchine_code:"baidu",Marchine_name:"百度"},
      {Marchine_code:"google",Marchine_name:"谷歌"},
      {Marchine_code:"360",Marchine_name:"360搜索"},
      {Marchine_code:"bing",Marchine_name:"必应搜索"},
      {Marchine_code:"zhihu",Marchine_name:"知乎搜索"},
      {Marchine_code:"wenku",Marchine_name:"百度文库"},
      {Marchine_code:"360photo",Marchine_name:"图片搜索"},
      {Marchine_code:"baidutieba",Marchine_name:"贴吧"},
      {Marchine_code:"baiduzhidao",Marchine_name:"知道"},
      {Marchine_code:"pandd",Marchine_name:"网盘"},
      {Marchine_code:"csdn",Marchine_name:"csdn"},
    ],
    button_value:"百度一下",
    searApi:"",
    searApi_weizui:"",
